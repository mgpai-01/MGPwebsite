...
export const es: Dictionary = {
  ...
  sustainability: {
    ...
    items: [
      ...
      { title: 'The Pallet University', body: 'Educación continua y capacitación certificada para la industria de las tarimas. MGP colabora con Pallet University para mantener a nuestro equipo — y a nuestros clientes — al día en estándares, seguridad y mejores prácticas.' },
    ],
  },
  about: {
